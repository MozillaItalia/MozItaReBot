...
from src.commands import rules, start, help, unknown, progetti, groups, feedback, social, vademecum, vg
load_dotenv()
...
def start_bot(token: str, base_url: str = None) -> None:
    ...
    dispatcher.add_handler(CommandHandler("vg", vg))
